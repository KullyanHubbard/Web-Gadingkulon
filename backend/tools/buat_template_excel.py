...
PETUNJUK = [
    ...
    "   - Satu kursi satu orang: jangan ada dua RT di RT yang sama.",
    "   - Dipakai HANYA saat kursinya masih kosong di aplikasi. Setelah",
    "     kursinya terisi, pergantian dilakukan lewat aplikasi (butuh",
